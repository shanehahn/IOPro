...
meta =1;
if(meta == 0 ){
//	printk("[AIOPro] rw %d, flag %d, sector %llu, size %lu, ino %d, name %s\n", 
//		srw, flag, (unsigned long long)slba, ssize, ino, fname);
	set_scsi_log2(bbtime, cctime, 900, srw, flag, ssize, slba, fname, ino);
}
else{
//	printk("[AIOPro] rw %d, flag %d, sector %llu, size %lu, ino ?, name ?\n", 
//		srw, flag, (unsigned long long)slba, ssize);
	set_scsi_log2(bbtime, cctime, 900, srw, flag, ssize, slba, "B", ino);
}
