...
#ifdef aiopro_bio
//printk("CFQ_DISPATCH_INSERT 0 -> ");
	if(rq!=NULL){
//printk("1 -> ");
		if(rq->bio != NULL){
//printk("2 ");
			do_posix_clock_monotonic_gettime(&cctime);
			set_bio_log(bbtime, cctime, 702, rq->bio);
		}
//		else printk("3 ");
	}
//	else printk("0 ");
...
#ifdef aiopro_bio
//printk("CFQ_INSERT_REQUEST 0 -> ");
	if(rq!=NULL){
//printk("1 -> ");
		if(rq->bio != NULL){
//printk("2 ");
			do_posix_clock_monotonic_gettime(&cctime);
			set_bio_log(bbtime, cctime, 701, rq->bio);
		}
//		else printk("3 ");
	}
//	else printk("0 ");
